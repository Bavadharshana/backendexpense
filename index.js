...
const PORT = 4000;
const MONGO_URI = 'mongodb+srv://Bavadharshana:Achubava@cluster0.yawhi7m.mongodb.net/ExpenseTrack?retryWrites=true&w=majority&appName=Cluster0'
//const PORT = 4000;//server entha port la run agum nu refer panna
